...
class ASTGCN_submodule(nn.Module):
    ...
    def __init__(self, K, model_topology):
        ...
        #self.embbeded =  EmbeddingBlock(input_dim = input_dim, output_dim = output_dim)
...
class ASTGCN(nn.Module):
    ...
    def forward(self, x_list):
        ...
        final_output =  torch.cat((submodule_outputs[0], submodule_outputs[1]) ,dim =2)
        final_output =  torch.cat((final_output, submodule_outputs[2]) ,dim =2)
